...
func add_cluster_game_object_collection(collection_name, feature_layer, cluster_points_layer, instance_goc):
	var collection = GameObjectClusterCollection.new(collection_name, feature_layer, cluster_points_layer, instance_goc)
	add_game_object_collection(collection)
	return collection
